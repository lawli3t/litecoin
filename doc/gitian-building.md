...
Output from `gbuild` will look something like
    ...
    From https://github.com/oakcoin-project/oakcoin
...
For example:
```bash
URL=https://github.com/thrasher-/oakcoin.git
...
BTCPATH=/some/root/path/oakcoin
SIGPATH=/some/root/path/oakcoin-detached-sigs

./bin/gbuild --url oakcoin=${BTCPATH},signature=${SIGPATH} ../oakcoin/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[oakcoin-project/gitian.sigs.ltc](https://github.com/oakcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
